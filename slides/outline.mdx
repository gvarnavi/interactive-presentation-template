...
<Tabs Lazy>
  ...
  <TabItem value="python" label="Python code" default >
	...
	For this configuration, this only loads the python stdlib and numpy by default.
	If you want to install additional packages you can use a comma-separated list as so:
	...
	res = special.cbrt(27)
	message = f"The cube root of 27 is {res}"
